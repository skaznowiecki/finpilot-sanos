  ...
  <div class="mb-6 border rounded-lg p-4 bg-accent/50">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="flex items-center gap-2">
        <input type="checkbox" id="newIsPrimary" :checked="form.isPrimary"
          @change="handlePrimaryChange(($event.target as HTMLInputElement).checked)" class="rounded border-gray-300" />
...
import type { CreateBankAccountRequest } from '@/features/auth/types'
